                            ...
                            ->schema([
                                ...
                                TextEntry::make('auditable_type')
                                    ...
                                    ->formatStateUsing(function (string $state, $record) {
										if (method_exists($record->auditable, 'translateAuditName')) {
											return Str::afterLast($record->auditable->translateAuditName(), '\\');
										}
                                ...
                                TextEntry::make('event')
                                    ->label(trans('filament-auditing::filament-auditing.infolist.event'))
										 ->formatStateUsing(function (string $state) {
											  return trans('filament-auditing::filament-auditing.infolist.event-name.'.$state);
										  }),
                                TextEntry::make('url')
